...
3) The third test for this program was a basic test, one without any links. Our group wanted to see what would happen if the getLinks method never actually found a link, and the results were as we expected.
